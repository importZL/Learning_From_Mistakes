...
parser.add_argument('--note', type=str, default='cifar10-LFM', help='experiment name')

parser.add_argument('--encoder-size', type=int, default=18, help='.')
parser.add_argument('--resume', type=str, default='./log/result-cifar100-PAM-200.0-20220802-003611')
...
def main():
    ...
    ave_weights_normal = scaler.fit_transform(ave_weights)
    plt.plot(ave_weights_normal)
...
def train(train_loader,
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        v_lambda = _compute_a(model_cal, encoder, r_vec, input_var, target_var, input_validation_var,
