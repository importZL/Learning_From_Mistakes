...
from model_cloth import ResNet50
from cutout import Cutout
from load_cloth1m_data import prepare_data
...
parser.add_argument('--batch_size', '--batch-size', default=48, type=int,
...
parser.add_argument('--note', type=str, default='resnet50-cloth', help='experiment name')
...
def build_dataset():
    ...
    train_loader, train_meta_loader, test_loader = prepare_data(args)
...
def build_model(len_train):
    ...
    model = ResNet50(num_classes=14, len_train=len_train, batch_size=args.batch_size)
